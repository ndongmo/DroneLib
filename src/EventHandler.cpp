...
#define JOY_AXE_DEFAULT_SPEED 100
#define AXIS_TIMELAPSE 50.0f

namespace NS2 {

	void EventHandler::updateMove(int& move)
	{
		move = (m_mouseCoords.x > 0) ? (int)m_mouseCoords.x : (int)m_mouseCoords.y;
		m_mouseCoords.x = m_mouseCoords.y = 0;
	}
